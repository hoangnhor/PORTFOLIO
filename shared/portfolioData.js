...
05/2026 - Hiện tại Portfolio Website – Personal Branding Platform`,
  socials: [
    { kind: "github", label: "GitHub", url: "https://github.com/hoangnhor" },
    { kind: "cmms-demo", label: "CMMS Demo", url: "https://htcmms.vercel.app/auth" },
    { kind: "petshop-demo", label: "PetShop Demo", url: "https://htpetshop.vercel.app/" },
    { kind: "website", label: "Website", url: "https://tranvanhoang.vercel.app/" }
  ],
  education: [
    {
  ...
  projects: [
    {
      ...
      links: [
        { kind: "demo", label: "Demo", url: "https://htcmms.vercel.app/auth" },
        { kind: "frontend", label: "Frontend", url: "https://github.com/hoangnhor/CMMS-FE" },
        { kind: "backend", label: "Backend", url: "https://github.com/hoangnhor/CMMS-BE" }
      ],
      highlights: [
    ...
    },
    {
      ...
      links: [
        { kind: "demo", label: "Demo", url: "https://htpetshop.vercel.app/" },
        { kind: "frontend", label: "Frontend", url: "https://github.com/hoangnhor/PETSHOP-FE" },
        { kind: "backend", label: "Backend", url: "https://github.com/hoangnhor/PETSHOP-BE" }
      ],
      highlights: [
    ...
    },
    {
      ...
      links: [
        { kind: "github", label: "GitHub Repo", url: "https://github.com/hoangnhor/PORTFOLIO" },
        { kind: "github", label: "Repository", url: "https://github.com/hoangnhor/portfolio" }
      ],
      highlights: [
